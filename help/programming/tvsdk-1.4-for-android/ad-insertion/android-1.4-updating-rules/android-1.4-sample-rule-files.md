...
在`AdobeTVSDKConfig.json`中，您可以指定特定区域的默认规则和规则。

## 默认规则示例{#section_xy4_3fx_hz}

以下是仅定义默认规则的`AdobeTVSDKConfig.json`文件示例：
...
以下是定义默认规则的[!DNL AdobeTVSDKConfig.json]文件的示例，此文件加上特定区域ID的其他规则（在此例中，区域&#x200B;**&quot;1234&quot;**）：
