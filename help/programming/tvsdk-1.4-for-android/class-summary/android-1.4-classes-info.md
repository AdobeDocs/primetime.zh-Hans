...
<table frame="all" colsep="1" rowsep="1" id="table_BC74F0C72F7C443B92C9B28750D812A6"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2">扩展的类 <span class="codeph"> Track</span> 以定义音轨抽象。 </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2">扩展的类 <span class="codeph"> Track</span> 定义隐藏式字幕抽象。 定义 <span class="codeph"> 隐藏字幕</span> 抽象化。 隐藏式字幕跟踪由其名称和服务类型唯一定义。 不同的服务类型可以共享相同的名称。</td> 
  </tr> 
  <tr rowsep="1"> 
