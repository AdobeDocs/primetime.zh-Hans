...
* `AuditudeResolver` for  `AUDITUDE_METADATA_KEY`for， whis connect to Adobe Primetime ad decisioning（以前称为Auditude）servers and returning ad breaks to be placed.
