...
1. 等待至 `MediaPlayer` 少处于“PREPARED”状态。 有关详细信息，请 [参阅等待有效状态](../../../../tvsdk-3x-android-prog/android-3x-content-playback-options-android2/ui-configure/android-3x-ui-state-prepared-wait-for.md)。
