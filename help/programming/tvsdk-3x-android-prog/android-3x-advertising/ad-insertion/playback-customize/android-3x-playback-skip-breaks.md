...
>[!IMPORTANT]
>
>如果必须完成内部搜寻才能宽恕广告，则播放期间可能会稍微暂停。

要覆盖默认的TVSDK广告时间行为，您可以扩展默认的广告策略选择器。 有四个广告时间策略可用：
...
* 跳过
   ...
   >[!NOTE]
   >
   >当直播点上有广告时，SKIP广告时间策略可能无法正常工作。 例如，对于前置广告，SKIP将导致搜寻到广告时间的结尾，这可能大于实时点。 在这种情况下，TVSDK可能会尝试访问广告中间。
