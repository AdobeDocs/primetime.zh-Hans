...
<table id="table_466538B1C2A646B89EB4F9AA111203BE"> 
 <thead> 
  <tr> 
   ...
   <th colname="col3" class="entry"><b>可通过以下方式自定义 <span class="codeph"> AdBreakPolicySelect</b></span> </th> 
  </tr>
 </thead>
 <tbody> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3">有关更多信息，请参阅 <a href="../../../tvsdk-3x-android-prog/android-3x-content-playback-options-android2/ui-configure/android-3x-ui-seek-scrub-bar-display.md" format="dita" scope="local"> 显示具有当前播放位置的搜寻拖拽栏</a>. </td> 
  </tr> 
 </tbody> 
</table>
