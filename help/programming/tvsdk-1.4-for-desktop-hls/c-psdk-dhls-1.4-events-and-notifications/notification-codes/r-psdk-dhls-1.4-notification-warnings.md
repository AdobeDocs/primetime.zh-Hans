...
<table frame="all" colsep="1" rowsep="1" id="table_C24772DF203B4DB2ACE6B475698C4C58"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="5"> <p>低级AVE库发出错误。 </p> <p>有关 <a href="../../c-psdk-dhls-1.4-events-and-notifications/notification-codes/c-psdk-dhls-1.4-native-error-summary.md" format="html" scope="external"> 这些元数据字段的值的详细信息</a> ，请参阅NATIVE_ERROR通知的详细信息。 </p> </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="4"><b>DRM</b> <p><span class="codeph"> NATIVE_SUBERROR_CODE</span><span class="codeph"> DRM_ERROR_STRING</span> </p> </td> 
   <td colname="5">DRM次要错误代码和DRM服务器错误字符串。 有关 <a href="../../c-psdk-dhls-1.4-events-and-notifications/notification-codes/c-psdk-dhls-1.4-native-error-summary.md" format="html" scope="external"> 这些元数据字段的值的详细信息</a> ，请参阅NATIVE_ERROR通知的详细信息。
   </td> 
  </tr> 
  <tr rowsep="1"> 
