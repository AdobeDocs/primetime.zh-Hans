...
<table frame="all" colsep="1" rowsep="1" id="table_389797D3CEF14EA2862E0B20C6E6CC41"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 课。 默认记录器将所有传入消息发送到跟踪。 </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/logging/Log.html" format="html" scope="external"> 日志</a></span> </td> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 课。 默认日志记录工厂。</td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/logging/Logger.html" format="html" scope="external"> 记录器</a></span> </td> 
   <td colname="2">界面。 为短语实现自定义记录器所需的方法。 </td> 
  </tr> 
  <tr rowsep="0"> 
