...
包： [com.adobe.mediacore.info](https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/info/package-detail.html)
...
<table frame="all" colsep="1" rowsep="1" id="table_BC74F0C72F7C443B92C9B28750D812A6"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 扩展Track以定义隐藏字幕抽象的类。 隐藏式字幕轨道由其名称AND及其服务类型唯一定义。 不同的服务类型可以共享相同的名称。</td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> 包含默认隐藏字幕的类可跟踪类型。 </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 定义DRM元数据抽象的类。 </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/info/Profile.html" format="html" scope="external"> 个人资料</a></span></td> 
