...
1. 实例化和配置AppMeasurement组件。
   ...
   AppMeasurement实例有许多配置选项。 有关详细信息，请参阅 [Adobe Analytics开发人员文档](https://microsite.omniture.com/t2/help/en_US/reference/#Developer) 。 以下示例代码(、和 `account`)中的 `visitorNamespace`选项是必 `trackingServer`需的，这些值由Adobe提供。
