...
1. 例項化及設定AppMeasurement元件。
   ...
   AppMeasurement例項有許多設定選項。 如需詳細資訊，請參閱 [Adobe Analytics開發人員](https://microsite.omniture.com/t2/help/en_US/reference/#Developer) 說明檔案。 下列範常式式碼中的選項( `account`， `visitorNamespace`、和 `trackingServer`)為必填專案，而值是由Adobe提供。
