---
description: UI框架是浏览器TVSDK顶部的UI层，它提供各种与视频播放器相关的现成UI构造。 您可以通过进行适合您的环境的点更改来创建高度可自定义的播放器。
seo-description: UI框架是浏览器TVSDK顶部的UI层，它提供各种与视频播放器相关的现成UI构造。 您可以通过进行适合您的环境的点更改来创建高度可自定义的播放器。
seo-title: UI框架
title: UI框架
