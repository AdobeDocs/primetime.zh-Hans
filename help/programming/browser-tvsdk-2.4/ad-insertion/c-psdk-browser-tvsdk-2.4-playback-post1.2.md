...
<table id="table_466538B1C2A646B89EB4F9AA111203BE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3">选择要播放的跳过的断点 <span class="codeph"> selectAdBreaksToPlay</span> 并确定已使用观察了哪些中断 <span class="codeph"> isWatched</span>. </td> 
  </tr> 
  <tr> 
...
您可以在广告内容工厂中设置您的首选行为 `retrieveAdPolicySelectorCallbackFunc` 方法。 您可以使用 `selectPolicyForAdBreak`， `selectWatchedPolicyForAdBreak`， `selectPolicyForSeekIntoAd`、和 `selectAdBreaksToPlay` 在内容工厂中选择策略的方法。
