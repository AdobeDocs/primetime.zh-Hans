...
<table id="table_3565328ABBEE4605A92EAE1ADE5D6F84"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>重要： 此JSON配置文件名必须保留<span class="codeph"> ADBMobileConfig.json </span>。 此配置文件的名称和路径无法更改。 此文件的路径必须为<span class="codeph"> &lt;source root&gt;/AdobeMobile </span>。 </p> </td> 
  </tr> 
  <tr> 
