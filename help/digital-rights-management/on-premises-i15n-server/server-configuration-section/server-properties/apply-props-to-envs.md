---
description: 必须配置服务器属性以反映您的环境。 您可以使用以下任何一项来执行此操作
title: 将属性应用于服务器环境
...
必须配置服务器属性以反映您的环境。 您可以使用以下任意一项来执行此操作：

* [!DNL flashaccess-i15n.properties]  — 包含于每个 [!DNL .war] 文件

* [!DNL AdobeInitial.properties]  — 示例位于 [!DNL /shared] DVD上的文件夹

   可以使用此文件覆盖WAR文件中设置的属性，如下所示：
...
您可以将单个属性应用于以下特定服务器环境：

* *开发*
* *暂存*
* *生产*

利用此功能，您可以为所有服务器环境使用相同的WAR文件。 要将属性应用于特定环境，请附加两个下划线字符(&#39; `__`&#39;)加上以下环境代码之一到属性 *name*：
