...
<table class="+ topic/table " id="table_p3x_54y_n4"> 
 ...
 <tbody class="- topic/tbody "> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry ">指定是否允许匿名域注册。 将属性设置为true或包含此命令行选项以允许匿名访问。 <p>注意：此选项不能与<span class="codeph"> -domainAuthNS</span>一起使用。 </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">内容变为无效的日期。 </p> <p>注意：不能同时指定<span class="codeph"> policy.expiration.endDate</span>和<span class="codeph"> policy.expiration.duration</span>。 </p> <p>例如，2009-01-31-14:30:00表示内容将于1月31日下午2:30过期。 </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
