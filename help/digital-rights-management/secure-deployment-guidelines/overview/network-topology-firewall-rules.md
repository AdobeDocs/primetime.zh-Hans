...
您可以配置外部防火墙，使其仅公开您要向最终用户提供的应用程序功能的URL。

外部用户可以通过使用外部防火墙访问以下URL:
...
<table frame="all" colsep="1" rowsep="1" class="+ topic/table adobe-d/table " id="table_bqs_whz_n4"> 
 ...
 <tbody class="- topic/tbody "> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">验证用户身份。 </p> <p>如果您使用Adobe Primetime DRM客户端API进行用户身份验证，则必须可访问此URL。 </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "> 
    <ul id="ul_yxs_rdn_44"> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">同步请求。 </p> <p>如果您在许可证中指定了同步要求，则必须可访问此URL。 </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "> 
    <ul id="ul_plq_ydn_44"> 
  ...
  <tr rowsep="0" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">LiveCycle Rights Management ESWeb服务URL。 如果内容已使用FMRMS的早期版本发布，则此URL允许较旧的客户端连接到服务器。 系统会提示这些客户端升级到Adobe Primetime DRM。 </p> <p class="- topic/p ">注意：此URL必须使用SSL(HTTPS)。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="1" class="- topic/entry "> 
   ...
   <td colname="2" class="- topic/entry "> <p>退回许可证。 </p> <p> 如果您实施了许可证退回支持，则必须可访问URL。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
>[!NOTE]
>
>内部防火墙应仅允许通过反向代理连接到Primetime DRM许可证服务器，并且仅允许连接到表中的URL。 要提高可伸缩性，请使用HTTP实现反向代理与Primetime DRM之间的连接。
