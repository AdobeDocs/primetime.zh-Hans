...
您可以配置外部防火墙，使其仅显示要向最终用户提供的应用程序功能的URL。

外部用户可以使用外部防火墙访问以下URL:
...
<table frame="all" colsep="1" rowsep="1" class="+ topic/table adobe-d/table " id="table_bqs_whz_n4"> 
 ...
 <tbody class="- topic/tbody "> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">验证用户身份。 </p> <p>如果您使用Adobe Primetime DRM客户端API进行用户身份验证，则必须可以访问此URL。 </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "> 
    <ul id="ul_yxs_rdn_44"> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">向最终用户发放许可证。 </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "> 
    <ul id="ul_ibl_5dn_44"> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">同步请求。 </p> <p>如果您在许可证中指定了同步要求，则必须可以访问此URL。 </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "> 
    <ul id="ul_plq_ydn_44"> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">注册域。 </p> <p>如果您实施域支持，则必须可以访问此URL。 </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "> 
    <ul id="ul_btm_c2n_44"> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">取消注册域。 </p> <p>如果您实施域支持，则必须可以访问此URL。 </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
  ...
  <tr rowsep="0" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">LiveCycle Rights Management ES Web服务URL。 如果内容已使用FMRMS的早期版本发布，则此URL允许旧客户端连接到服务器。 系统会提示这些客户升级到Adobe Primetime DRM。 </p> <p class="- topic/p ">注意：此URL必须使用SSL(HTTPS)。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="1" class="- topic/entry "> 
   ...
   <td colname="2" class="- topic/entry "> <p>退回许可证。 </p> <p> 如果您实施许可证退回支持，则必须可以访问该URL。 </p> </td> 
  </tr> 
 </tbody> 
</table>
